            ...
            <div class="container px-5 mx-auto">
              ...
              <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <form method="post" action="{{ route('admin.owners.update', ['owner' => $owner->id])}}">
                  {{-- 擬似フォームメソッドHTMLのFormはPUT,PATCHをサポートしていないため --}}
                  @method('PUT')
                  @csrf
                  <div class="-m-2">
                    ...
                    <div class="p-2 w-full flex justify-around mt-4">
                      ...
                      <button type="submit"
                        class="text-black bg-indigo-500 border-0 py-2 px-8 ml-2 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                    </div>
